...
WebUI.navigateToUrl('https://www.ups.com/us/en/Home.page')
...
WebUI.setText(findTestObject('Object Repository/UPS_Login_Testing/Page_Login  UPS - United States/userId'), user)

WebUI.setText(findTestObject('Object Repository/UPS_Login_Testing/Page_Login  UPS - United States/password'), pass)
